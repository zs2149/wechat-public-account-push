export const config = {
  ...
  // 公众号APP_ID
  APP_ID: "wx9b608b0e6b21515c",
  APP_SECRET: "7f9b35dcd6e287b030594ab404be1b3c",
  IS_SHOW_COLOR: true,
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "琳琳宝贝", "year": "1999", "date": "09-04","type":'new'},
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "老婆", "year": "1999", "date": "09-04", isShowAge: true},
